//
//  WCPresidentSpeechViewController.m
//  WCWork
//
...
#import "WCPresidentSpeechViewController.h"
#import <WebKit/WebKit.h>
#import "NSString+GQExtension.h"

#define SPEECH_URL @"http://mobile.zjmi.com:8080/upload/image/dszzc.jpg"

@interface WCPresidentSpeechViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WCPresidentSpeechViewController
...
- (void)viewDidLoad {
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:SPEECH_URL]]];
}
