...
#import "WCCommonToolsViewController.h"
#import <WebKit/WebKit.h>

#define TOOL_URL @"http://mobile.zjmi.com/zjmiapp/Mobile/utility/index"

@interface WCCommonToolsViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WCCommonToolsViewController
...
- (void)viewDidLoad {
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:TOOL_URL]]];
}
