...
#import "WCHRViewController.h"
#import <WebKit/WebKit.h>
#import "NSString+GQExtension.h"

#define JCFX_URL @"http://biportal.zjmi.com:8080/xplatform/login.action?appSSO=true&rtype=hr"

@interface WCHRViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WCHRViewController
