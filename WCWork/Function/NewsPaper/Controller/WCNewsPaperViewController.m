...
#import "WCNewsPaperViewController.h"

@interface WCNewsPaperViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WCNewsPaperViewController
...
- (void)viewDidLoad {
    ...
    NSString *url = [NSString stringWithFormat:@"%@",NEWSPAPER];
