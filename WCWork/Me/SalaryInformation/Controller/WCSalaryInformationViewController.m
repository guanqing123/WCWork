//
//  WCSalaryInformationViewController.m
//  WCWork
//
...
@interface WCSalaryInformationViewController ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, weak)  WKWebView *webView;
@end

@implementation WCSalaryInformationViewController
...
- (void)viewDidLoad {
    ...
    NSString *url = [NSString stringWithFormat:@"%@b=%@&s=a2&AppId=%@&Timestamp=%@&UserSign=%@",YGXX_URL,userName,AppId,timeStamp,UserSign];
